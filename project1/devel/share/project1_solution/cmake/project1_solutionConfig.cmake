...
if("TRUE" STREQUAL "TRUE")
  set(project1_solution_SOURCE_PREFIX /home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/src/project1_solution)
  set(project1_solution_DEVEL_PREFIX /home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/devel)
  ...
  set(project1_solution_INSTALL_PREFIX /home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/install)
...
if(NOT "/home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/devel/include " STREQUAL " ")
  set(project1_solution_INCLUDE_DIRS "")
  set(_include_dirs "/home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'project1_solution' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/src/project1_solution/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ccc_v1_w_NmY1N_85909/asn28980_1/asn28981_1/work/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(project1_solution_EXPORTED_TARGETS "project1_solution_generate_messages_cpp;project1_solution_generate_messages_lisp;project1_solution_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${project1_solution_dep}_FOUND)
      find_package(${project1_solution_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${project1_solution_dep} REQUIRED ${depend_list})
  endif()
